...
const admin = conn.define('admin', {
  ...
  admin_name: { type: DataTypes.STRING(30), allowNull: false },
  admin_email: { type: DataTypes.STRING(100), allowNull: false },
  admin_phone: { type: DataTypes.STRING(11), allowNull: true },
  password_login_adm: {
    type: DataTypes.STRING(400),
    allowNull: false,
  },
...
const bank = conn.define('bank', {
  ...
  CVC: { type: DataTypes.STRING(3), allowNull: false },
  installment: {
...
const product = conn.define('product', {
  ...
  price_Small: { type: DataTypes.STRING(10), allowNull: true },
  price_Medium: { type: DataTypes.STRING(10), allowNull: true },
  price_Large: { type: DataTypes.STRING(10), allowNull: true },
  stock_prod: { type: DataTypes.STRING(5), allowNull: true },
...
const order = conn.define('order', {
  ...
  status_order: { type: DataTypes.STRING(40), allowNull: false },
  total_order: { type: DataTypes.STRING(10), allowNull: false },
});
...
const evaluation = conn.define('evaluation', {
  ...
  name_feed: { type: DataTypes.STRING(80), allowNull: false },
  note: { type: DataTypes.STRING(1), allowNull: false },
